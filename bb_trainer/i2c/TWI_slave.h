...
extern volatile uint8_t*  gp_TWI_transmitBuf;   // Transmit buffer. Data to send to the Master.
extern volatile uint8_t*  gp_TWI_receive_buf;    // Receive buffer. Data received from the Master.

extern volatile uint8_t g_TWI_readInProgress;
extern volatile uint8_t g_TWI_writeInProgress;
extern volatile uint8_t g_TWI_writeComplete;
extern volatile uint8_t g_TWI_readComplete;
