...
void DifferentialParametersRepository::startListeningForUpdates()
{
  ...
  {
    _p_dynamic_reconfigure_server = new dynamic_reconfigure::Server<diff_drive_calibrated::DifferentialParametersConfig>;
    dynamic_reconfigure::Server<diff_drive_calibrated::DifferentialParametersConfig>::CallbackType call_back_type;
...
void DifferentialParametersRepository::updateParametersCallBack( const diff_drive_calibrated::DifferentialParametersConfig &config, uint32_t level)
{
